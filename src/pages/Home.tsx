...
export default function Home() {
  return <div className="p-10 border-2 mx-auto my-5 min-w-60 max-w-220 text-2xl">
    ...
    <div className="flex flex-row min-w-50 gap-5 max-w-200 mx-auto">
      <Button variant='primary' className="w-full">Comenzar simulacion +</Button>
      <Button variant='info' className="w-full">Ver documentacion</Button>
    </div>
  </div>;
}